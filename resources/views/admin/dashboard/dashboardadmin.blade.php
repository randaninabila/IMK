            ...
            <div class="flex items-center gap-[22px]">
                ...
                <div class="relative">
                    <button type="button"
                        ...
                        <div class="w-[46px] h-[46px] rounded-full bg-white flex items-center justify-center text-[25px] shadow-sm">
                            👩🏻‍💼
                        </div>
                    ...
                    <div id="profileDropdown"
                         class="hidden absolute right-0 top-[56px] w-[190px] bg-white rounded-[12px] shadow-xl border border-[#F1D9DD] overflow-hidden z-50">
