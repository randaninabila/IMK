<footer class="bg-[#3E382D] text-[#F3EFE0] py-6 px-8">
    ...
    <div class="flex gap-4 md:col-span-1 items-start">
        ...
        {{-- CONTACT + SOCIAL --}}
        <div>
            <h4 class="font-bold tracking-widest text-sm mb-4 uppercase">Ikuti Kami</h4>
            <div class="flex gap-4 items-center mb-6">
                <a href="https://www.instagram.com/dina_salon_muslimah?igsh=MTNlMTc0eXJjMzR3dA=={{ urlencode($cabang->nama_cabang) }}" class="hover:opacity-75 transition-opacity" aria-label="Instagram">
                ...
                <a href="https://wa.me/6287869590802?text=Halo%20Salon%20Dina,%20saya%20ingin%20booking%20di%20{{ urlencode($cabang->nama_cabang) }}" class="hover:opacity-75 transition-opacity" aria-label="WhatsApp">
                    <svg class="w-7 h-7" fill="currentColor" viewBox="0 0 24 24">
    ...
    <div class="max-w-7xl mx-auto mt-12 pt-6 border-t border-white/10 text-center text-xs opacity-50">
        © {{ date('Y') }} Salon Muslimah Dina.</div>
</footer>