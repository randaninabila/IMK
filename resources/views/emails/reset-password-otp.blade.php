...
<head>
    ...
    <title>Reset Password — Dina Salon Muslimah</title>
    <style>
...
<body>
    <div class="wrapper">
        ...
        <div class="body">
            ...
            <p class="desc">
                Kami menerima permintaan reset password untuk akun kamu yang terdaftar dengan email
                <strong>{{ $user->email }}</strong>.<br><br>
                Gunakan kode OTP di bawah ini untuk melanjutkan proses reset password. Kode ini hanya berlaku selama <strong>15 menit</strong>.
            </p>

            <div class="otp-block">
                <div class="otp-label">Kode OTP Reset Password</div>
                <div class="otp-code">{{ $otp }}</div>
                <div class="otp-expire">⏱ Berlaku hingga {{ now()->addMinutes(15)->format('H:i') }} WIB</div>
            </div>
