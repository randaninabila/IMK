...
<head>
    ...
    <style>
        * { box-sizing: border-box; }
        ...
        .resend-btn { transition: all 0.2s ease; }
    ...
    <div class="w-full max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
        ...
        <div class="anim-left">
            ...
            <div class="inline-flex items-center gap-2 border border-[#3d352f]/20 rounded-full px-4 py-1.5 mb-6">
                ...
                <span class="text-[#3d352f] text-xs font-medium tracking-wide">Verifikasi Akun Baru</span>
            </div>
            ...
            <div class="mt-10 space-y-3 max-w-xs">
                ...
                @foreach([
                    ...
                    ['num' => '3', 'label' => 'Akun Aktif',            'state' => 'next'],
                ] as $step)
            ...
            <div class="relative bg-white/35 backdrop-blur-2xl border border-[#3D352F]/35
                ...
                <div class="text-center mb-7">
                    <div class="w-16 h-16 rounded-2xl bg-[#3d352f]/08 border border-[#3d352f]/15 flex items-center justify-center mx-auto mb-4">
                        <i data-feather="mail" class="w-7 h-7 text-[#3d352f]"></i>
                    </div>

                    <h2 class="text-3xl font-bold text-[#3d352f]">Verifikasi Email</h2>
                ...
                <form method="POST" action="{{ route('verification.verify-otp') }}" id="otpForm">
                    ...
                    <div class="text-center mb-6">
                        <p class="text-sm text-[#7a6d65]">
                            Kode berlaku selama
                            <span id="countdown" class="countdown-active font-semibold">60:00</span>
                        </p>
                    </div>
                ...
                <!-- Resend — user sudah login saat registrasi -->
                ...
                <p class="text-center mt-5 text-sm text-[#3d352f]/60">
                    Email salah?
                    <a href="{{ route('register') }}" class="font-semibold text-[#3d352f] underline underline-offset-2 hover:text-[#6b5b4d] transition-colors">
                        Daftar ulang
                    </a>
                </p>
    ...
    <script>
        ...
        boxes.forEach((box, i) => {
            ...
            box.addEventListener('paste', (e) => {
                ...
                if (lastFilled < boxes.length - 1) boxes[lastFilled + 1]?.focus();
        ...
        // ========================
        // MAIN COUNTDOWN (60 min)
        // ========================
        let mainSeconds = 60 * 60;
